               ...
               <div class="head">
                  ...
                  <table id="prodTable" class="table table-striped" style="width:100%">
                        ...
                        <tbody>
                            ...
                            $sql = "SELECT ID, ProductName, Category, Quantity, SalesPrice FROM products ORDER BY ID DESC";
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td class='text-start'>" . $row['Quantity'] . "</td>";
                                    echo "<td class='text-start'>" . $row['SalesPrice'] . "</td>";
